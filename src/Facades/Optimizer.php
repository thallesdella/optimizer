 ...
 *
 * @method \ThallesDella\Optimizer\Optimizer optimize(string $title, ?string $description = null, ?string $url =null, ?string $image = null, bool $follow = true)
 * @method \ThallesDella\Optimizer\Optimizer publisher(string $fbPage, string $fbAuthor = null)
 * @method \ThallesDella\Optimizer\Optimizer openGraph(string $siteName, string $locale = "pt_BR", string $schema ="article")
 * @method \ThallesDella\Optimizer\Optimizer twitterCard(string $creator, string $site, string $domain, string $card =null)
